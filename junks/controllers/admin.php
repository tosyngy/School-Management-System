...
//             $this->view->show_admin("admin/login.php");
    ...
    public function students() {
         ...
         //students personal
        $students_personal = $this->model->view_students_personal();
        $this->view->students_personal = $students_personal;

        //students contact
        $students_contact = $this->model->view_students_contact();
        $this->view->students_contacts = $students_contact;


        //student picture
        $students_picture = $this->model->view_students_picture();
        $this->view->students_picture = $students_picture;
