...
//                         alert(sex)
//                         alert(nation)
                         if (firstname ==="" ||middlename ===""||lastname ==="" ||dateof ===""||placeof===""||religion===""||sex===""||nation==="") {
                        $("#error").empty();
...
//                         alert("e")
                                  if (address =="" || mobile =="" || city ===""||state===""||mail==="") {
...
//                         alert(sex)
//                         alert(nation)
                         if (pa_fullname ==="" ||pa_relation ===""||pa_dateof ==="" ||pa_occu ===""||pa_address===""||pa_officeadd===""||pa_mail===""||pa_mail==="") {
                        $("#error").empty();
...
//        alert(admited_term)
             ...
             $.post("http://localhost/schoolmgt/index/submit",
                {
