...
<!--            <input type="text"  class="form-control" id="autocomplete" name="street"  placeholder="Type your full address"/><br/>
            ...
            <fieldset>
                ...
                <input type="button" name="next" rel="2" class="next action-button" value="Next" />
                 ...
                 <fieldset>
                <h2 class="fs-title">parental Information</h2>
                <!--<h3 class="fs-subtitle">Name, Registration Number . . .</h3>-->
                <div id="error4"></div>
            ...
            <fieldset>
                ...
                <div id="error3"></div>
                  <input class="error3 admin" type="text" name="admin_no" placeholder="Admission Number" />
...
<!--                <input class="error2" type="text" name="company_reg_no" placeholder="City" />
                <input class="error2" type="text" name="phone_number" placeholder="State" />-->
                <input type="button" name="previous" class="previous action-button" value="Previous" />
 ...
 <!--<script src="<?php echo URL; ?>views/index/js/event.js"></script>-->
        <script src="<?php echo URL; ?>views/index/js/std.js"></script>
    </body> 
</html>
